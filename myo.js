...
function AddUQ(){
    ...
    window[`${localStorage.getItem("userQuizName")}q${localStorage.getItem("qi")}`] = new Question(localStorage.getItem("qi"), UserQuestionPrompt, UserQuestionAnswer);
    localStorage.setItem(`${localStorage.getItem("userQuizName")}q${localStorage.getItem("qi")}`, )
